...
p [10:200]  "E_iter_listd2.txt" u ($1):($2)  t "D=10, d_o=2" with points  pointtype 7 lw 3  ps 4.0 lc rgb "#cc0000","E_iter_listd4.txt" u ($1):($2)  t "D=10, d_o=4" with points  pointtype 11 lw 3  ps 4.0 lc rgb "#fdc328", -1.267219  t "D=10, DMRG" with line lw 4 linetype 7 lc rgb "#204a87"

#,"EnergyIterd6D4.txt" u ($1):($2)  t "D=4, d_o=6" with points  pointtype 21 lw 3  ps 4.0 lc rgb "#204a87", "EnergyIterD2.txt" u ($1):($2)  t "D=2, PEPS" with points  pointtype 13 lw 3  ps 4.0 lc rgb "#c17d11"
