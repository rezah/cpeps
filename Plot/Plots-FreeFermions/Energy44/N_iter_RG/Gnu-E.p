...
p  "N.txt" u ($1):($3)  t "Q-update" with points  pointtype 7 lw 3  ps 4.0 lc rgb "#5c3566" , "NPEPS.txt" u ($1+12):($3)  t "peps-update" with points  pointtype 9 lw 3  ps 4.0 lc rgb "#ef2929" 
