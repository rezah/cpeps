...
p  "PEPSZ2.txt" u ($1):($2)  t "Z2-PEPS" with points  pointtype 7 lw 3  ps 4.0 lc rgb "#5c3566" ,"PEPSU1.txt" u ($1):($2)  t "U1-PEPS" with points  pointtype 9 lw 3  ps 4.0 lc rgb "#f57900"
